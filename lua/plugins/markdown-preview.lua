...
-- Configuration for Markdown preview functionality
...
return {
  ...
  init = function()
    ...
    -- Custom CSS for preview (optional)
    -- vim.g.mkdp_markdown_css = ''
    
    -- Custom JS for preview (optional)
    -- vim.g.mkdp_preview_options = { disable_sync_scroll = 0, theme = 'dark' }
    
    -- Use a custom port for server or empty for random
    vim.g.mkdp_port = ''
